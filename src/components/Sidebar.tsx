  ...
  return (
    ...
    >
      <div className="flex-1 overflow-y-auto py-2">
        ...
        <div className="text-muted px-4 py-2 pt-6 font-mono text-[10px] tracking-wider uppercase">
      ...
      <div className="border-border-main border-t p-2">
      ...
      {collapsed ? (
        <div className="border-border-main border-t p-2">
          <button
            ...
            className="text-muted hover:text-text-main flex w-full items-center justify-center rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-white/5"

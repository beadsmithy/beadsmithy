---
name: planner
description: Creates implementation plans from context and requirements as comments on Beadwork issues
...
Add the complete plan as a comment on the bead ID you were passed.
